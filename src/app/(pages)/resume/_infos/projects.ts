...
const laud: IProject['projectList'] = [
  {
...
const blq: IProject['projectList'] = [
  {
...
const wello: IProject['projectList'] = [
  {
    title: '',
...
const wefun: IProject['projectList'] = [] as const
const hivelab: IProject['projectList'] = [] as const

const projects: IProject = {
  isShow: true,
  projectList: [...laud, ...blq, ...wello, ...wefun, ...hivelab],
}
